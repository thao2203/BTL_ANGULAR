...
namespace btlBanGhe
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "btlBanGhe", Version = "v1" });
            });
            ...
            services.AddTransient<DAL.Interface.Iorders, DAL.ordersDAL>();
            services.AddTransient<DAL.Interface.IorderDetail, DAL.OrderDetailDAL>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "btlBanGhe v1"));
            }
